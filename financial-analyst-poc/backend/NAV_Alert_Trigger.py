...
def trigger_alert_node(state: FinancialState):
...
graph.add_node("trigger_alert", trigger_alert_node)

# Define edges (workflow)
graph.set_entry_point("fetch")
graph.add_edge("fetch", "analyze")
graph.add_edge("analyze", "trigger_alert")
graph.set_finish_point("trigger_alert")
